...
//------------------------------------------------------------------------------
#ifndef nmenuLinkage
#define nmenuLinkage __declspec (dllimport)
#endif
...
extern nmenuLinkage /*const*/ Win32Type g_Shell;
extern nmenuLinkage BOOL bRemoteSession;

/////////////////////////////////////////////////////////////////////////////
// Global helperfunctions
UINT nmenuLinkage GetSafeTimerID(HWND hWnd, const UINT uiElapse);
BOOL nmenuLinkage DrawMenubarItem(CWnd* pWnd,CMenu* pMenu, UINT nItemIndex,UINT nState);
...
class nmenuLinkage CNewMenuIcons : public CObject
{
...
class nmenuLinkage CNewMenuBitmaps : public CNewMenuIcons
{
...
class nmenuLinkage CNewMenuItemData : public CObject
{
...
class nmenuLinkage CNewMenu : public CMenu
{
...
class nmenuLinkage CNewMiniDockFrameWnd: public CNewFrame<CMiniDockFrameWnd> 
{
...
class nmenuLinkage CNewDialog : public CNewFrame<CDialog>
{
...
class nmenuLinkage CNewMiniFrameWnd : public CNewFrame<CMiniFrameWnd>
{
...
class nmenuLinkage CNewMDIChildWnd : public CNewFrame<CMDIChildWnd>
{
...
class nmenuLinkage CNewFrameWnd : public CNewFrame<CFrameWnd>
{
...
class nmenuLinkage CNewMDIFrameWnd : public CNewFrame<CMDIFrameWnd>
{
...
class nmenuLinkage CNewMultiDocTemplate: public CMultiDocTemplate
{
...
class nmenuLinkage CNewMenuHelper
{
private:
  DWORD m_dwOldFlags;
